...
<section class="hub-notsure" aria-label="Not sure if we are the right fit">
    <div class="container">
        <div class="hub-notsure__inner animate-on-scroll">
            ...
            <p class="hub-notsure__body">Book a 15-minute Discovery Call. We will tell you honestly whether Bluu makes sense for your business right now — and if the timing is not right, we will say so. No pitch, no pressure.</p>
            <a href="<?php echo esc_url( home_url( '/contact' ) ); ?>" class="btn-primary btn-primary--large">Book a Discovery Call</a>
        </div>
    </div>
</section>
...
<section class="industry-pg-cta" aria-label="Call to action">
    <div class="container">
        <div class="animate-on-scroll">
            ...
            <p class="industry-pg-cta__sub">Book a 15-minute Discovery Call — honest, no pressure, and specific to your industry and situation.</p>
