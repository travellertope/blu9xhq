...
$cta_headline    = ( function_exists( 'get_field' ) ? get_field( 'home_cta_headline' )    : '' ) ?: 'Ready to Replace Fragmentation With Growth?';
$cta_body        = ( function_exists( 'get_field' ) ? get_field( 'home_cta_body' )        : '' ) ?: 'Book a 15-minute Discovery Call. No pitch — just honest assessment to see if our unified framework makes sense for you.';
