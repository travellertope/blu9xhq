...
acf_add_local_field_group( array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'          => 'textarea',
            'rows'          => 2,
            'default_value' => '15 minutes. No pitch, no pressure — just an honest conversation to see if Bluu is the right fit for where your business is right now.',
        ),
        array(
...
acf_add_local_field_group( array(
    ...
    'fields' => array(
        ...
        array( 'key' => 'field_ind_cta_subtext',         'label' => 'Subtext',          'name' => 'ind_cta_subtext',         'type' => 'textarea', 'rows' => 2, 'default_value' => 'We will tell you honestly whether Bluu makes sense for your stage, your team size, and your goals. No pitch, no pressure.' ),
...
acf_add_local_field_group( array(
    ...
    'fields' => array(
        ...
        array( 'key' => 'field_si_cta_subtext',         'label' => 'Subtext',         'name' => 'si_cta_subtext',         'type' => 'textarea', 'rows' => 2, 'default_value' => '— we will tell you honestly whether Bluu makes sense for your stage and what starting would look like.' ),
