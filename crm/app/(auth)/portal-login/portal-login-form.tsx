...
function PortalLoginFormInner({ logoUrl, tenantName, accentColour }: PortalLoginFormProps) {
  ...
  return (
    <div className="min-h-screen flex" style={{ "--tenant-accent": accentColour } as React.CSSProperties}>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <img src={logoUrl} alt={tenantName} className="h-9 brightness-0 invert" />
        </div>
      ...
      <div className="flex-1 flex flex-col bg-white">
        <div className="flex-1 flex flex-col items-center justify-center px-8 py-12 lg:px-16">
          ...
          <div className="lg:hidden mb-8 self-start">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={logoUrl} alt={tenantName} className="h-7" />
          </div>
              ...
              <>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full border border-slate-200 rounded-lg px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[var(--tenant-accent)] focus:border-transparent transition"
                      autoComplete="email"
                    />
                    {errors.email && (
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-[var(--tenant-accent)] hover:brightness-90 text-white rounded-lg px-4 py-2.5 text-sm font-semibold disabled:opacity-50 transition-[filter]"
                  >
                ...
                <div className="flex flex-col gap-2 pt-1">
                  <button
                    ...
                    className="text-sm text-slate-500 hover:text-[var(--tenant-accent)] transition-colors text-left"
                  >
            ...
            {showForgotPassword && (
              <div className="space-y-4">
                  ...
                  <>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        placeholder="you@company.com"
                        className="w-full border border-slate-200 rounded-lg px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[var(--tenant-accent)] transition"
                        autoComplete="email"
                      />
                    </div>
                    <button
                ...
                <button
                  ...
                  className="text-sm text-slate-500 hover:text-[var(--tenant-accent)] transition-colors"
                >
                  ← Back to sign in
                </button>
              </div>
        ...
        <div className="px-8 pb-8 text-center">
          <p className="text-xs text-slate-400">
            ...
            <a
              ...
              className="text-slate-500 hover:text-[var(--tenant-accent)] underline underline-offset-2 transition-colors"
            >
...
export default function PortalLoginForm(props: PortalLoginFormProps) {
  return (
    <Suspense>
