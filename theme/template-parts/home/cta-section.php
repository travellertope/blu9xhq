...
$cta_body        = ( function_exists( 'get_field' ) ? get_field( 'home_cta_body' )        : '' ) ?: 'Book a 15-minute Discovery Call. No pitch, no pressure — just an honest conversation to see if Bluu is the right fit for where your business is right now.';
