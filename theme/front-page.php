        ...
        <div class="scan-hero__grid">
            ...
            <div class="scan-hero__demo" aria-hidden="true">
                <div class="scan-hero__demo-top">
                    ...
                    <span class="scan-hero__demo-url">bluuhq.com/scan</span>
                </div>
...
<section class="home-cta" id="cta" aria-label="Call to action">
    <div class="container container--narrow">
        ...
        <div class="scan-hero__cta-group">
            <a href="#top" class="btn-primary btn-primary--large">Run your free scan</a>
            <a href="<?php echo esc_url( home_url( '/contact' ) ); ?>" class="btn-outline btn-outline--large">Book a Discovery Call</a>
        </div>
