...
$uc_content = array(
    'competitor-intelligence' => array(
        ...
        'deliverables_intro' => 'Every week and every quarter, you receive structured intelligence that makes your content and positioning decisions faster and better informed. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Weekly digest delivered every Monday. Quarterly analysis delivered at the end of each quarter. All included in your monthly retainer. All content delivered SEO and AI crawl ready.',
    ...
    'founder-brand' => array(
        ...
        'deliverables_intro' => 'A consistent, founder-led content presence that builds over time without taking hours from your week. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Posting 2–3 times per week on LinkedIn. Monthly calendar shared at the start of each month. All included in your monthly retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'content-repurposing' => array(
        ...
        'deliverables_intro' => 'For every long-form piece in your retainer, you receive a full suite of channel-specific assets published in the same week. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Repurposing begins within 48 hours of source content completion. All channel assets published within the same week. Included in your monthly retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'product-launch-content' => array(
        ...
        'deliverables_intro' => 'A complete, channel-ready content package for every significant launch — produced in advance and ready to deploy on the day. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Full package delivered 3–5 days before launch date. Post-launch piece delivered 7 days after. Included in your monthly retainer for planned launches. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'own-brand-content' => array(
        ...
        'deliverables_intro' => 'A fully managed own-brand content operation that keeps your business visible while you focus on clients. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Content published on a consistent weekly schedule. Newsletter sent monthly. Intelligence digest delivered at the start of each month. All included in your retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'thought-leadership' => array(
        ...
        'deliverables_intro' => 'A consistent programme of published thought leadership that builds your authority and visibility over time. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Articles published on a consistent schedule throughout the month. Market commentary published within 48 hours of relevant developments. All included in your retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'white-label-production' => array(
        ...
        'deliverables_intro' => 'A reliable white-label production resource that delivers quality first drafts to your brief, on time, every time. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Turnaround times agreed at onboarding. Standard: 48–72 hours from brief. Rush: same-day or next-day by arrangement. Volume discussed monthly. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'service-launch' => array(
        ...
        'deliverables_intro' => 'A complete content package to launch and sustain awareness of your new service across every relevant channel. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Launch package delivered 5 days before go-live date. Post-launch pieces delivered across the 30 days following launch. Available as a standalone engagement or within a retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'brand-storytelling' => array(
        ...
        'deliverables_intro' => 'A consistent, on-brand content presence across blog, email, and social — produced and published every month without you having to manage it. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Published on a consistent weekly schedule. Newsletter sent monthly. Performance report delivered at the end of each month. All included in your retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'product-content' => array(
        ...
        'deliverables_intro' => 'A complete content package for every product launch or collection drop — ready before the launch date, consistent in voice throughout. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Full launch package delivered 3–5 days before launch date. Post-launch content delivered on a rolling schedule. Available within a retainer or as a standalone launch package. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'email-newsletter' => array(
        ...
        'deliverables_intro' => 'A fully managed email newsletter programme that builds a loyal, engaged subscriber base over time. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Weekly or fortnightly sending schedule agreed at onboarding. Each newsletter reviewed and approved by you before sending. All included in your retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'market-intelligence' => array(
        ...
        'deliverables_intro' => 'Structured, actionable intelligence about your category delivered weekly — so you are always informed and never caught off guard. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Weekly digest every Monday. Trend alerts within 24 hours of significant events. Quarterly report at end of each quarter. All included in your retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'expert-commentary' => array(
        ...
        'deliverables_intro' => 'A consistent programme of published expert commentary that builds your visibility and authority in your field over time. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Regular pieces published 2–4 times per month. Timely commentary within 24–48 hours of relevant developments. All included in your retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'client-education' => array(
        ...
        'deliverables_intro' => 'A consistent educational content programme that demonstrates your expertise to prospects and deepens relationships with existing clients. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'One guide or explainer per month. Newsletter monthly. LinkedIn posts weekly. All included in your retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'referral-trust-content' => array(
        ...
        'deliverables_intro' => 'A consistent programme of content and communications designed to nurture referral relationships and reinforce trust with existing clients. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Newsletter monthly. Shareable content 2–3 times per month. LinkedIn posts weekly. Relationship touchpoints as occasions arise. All included in your retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
    ...
    'linkedin-authority' => array(
        ...
        'deliverables_intro' => 'A consistent, professionally managed LinkedIn presence that builds your authority and visibility with the people who hire and refer professional services firms. Every deliverable is built to SEO and AI crawl standard — structured for discovery in search and AI from the first draft.',
        'deliverables'       => array(
        ...
        'cadence'            => 'Posts published 3–4 times per week. Articles once or twice per month. Monthly performance review at the end of each month. All included in your retainer. All content delivered SEO and AI crawl ready.',
        'fit_statements'     => array(
